...
(function() {
  ...
  header.innerHTML =
    '<div class="header-left">' +
      '<a href="https://github.com/terryum/survey-robot-hand-tactile-sensor" target="_blank" rel="noopener" class="header-icon" title="GitHub Repository">' +
      ...
      '</a>' +
    '</div>' +
    '<a href="./" class="header-logo">Tactile Sensing & Robot Hands</a>' +
