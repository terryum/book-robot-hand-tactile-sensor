...
sources:
  ...
  - "논문 요약 포스트: terry.artlab.ai (DexForce, PP-Tac, Canonical 3D Tactile)"
...
> - 힘 기반 학습(DexForce, ForceVLA)의 접근과 의의를 이해합니다.
...
Yin et al. [2024]은 이진 3축 촉각 피부(binary 3-axis tactile skin) 센서 모델을 개발하여:
- **5,000 FPS** 시뮬레이션 속도
...
- **Canonical 3D Tactile** 표현으로 센서 독립적 전이
...
![Figure 7.4: 힘 기반 학습의 두 접근 — DexForce와 ForceVLA 비교.](../../assets/figures/ch07/fig_7_4_force_learning_technical.png)
...
6. Yin, Z.-H., et al. (2024). Learning in-hand translation using shear and normal forces via a binary 3-axis tactile skin. *arXiv preprint*. arXiv:2407.xxxxx.
...
11. Chen, C., Yu, Z., Choi, H., Cutkosky, M., & Bohg, J. (2025). DexForce: Extracting force-informed actions from kinesthetic demonstrations for dexterous manipulation. *IEEE Robotics and Automation Letters*. arXiv:2501.10356.

12. Yu, J., Liu, H., Yu, Q., Ren, J., Hao, C., Ding, H., Huang, G., Huang, G., Song, Y., Cai, P., Lu, C., & Zhang, W. (2025). ForceVLA: Enhancing VLA models with a force-aware MoE for contact-rich manipulation. *NeurIPS 2025*. arXiv:2505.22159.
