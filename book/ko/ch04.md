...
sources:
  - "세미나 PDF: 260323_Seminar_SNU_Inchul_Hand_Gripper_Mechanism"
...
LEAP Hand의 설계 철학은 "최소한의 비용으로 최대한의 손재주(dexterity)"입니다. 새로운 운동학적 구조(kinematic structure)로 인간 손의 핵심 자유도를 재현하면서, 저가 서보 모터와 3D 프린팅 부품만으로 구현했습니다.
...
- 2,000 CHF 이하, 8시간 제작
- **통합 촉각 센서** 포함
- 연속 학습(continuous learning)을 위한 설계
