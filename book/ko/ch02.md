...
sources:
  - "세미나 PDF: 260323_Seminar_SNU_Taejoon_DataGlove_Sensors"
...
**장점**: 낮은 비용, 단순 구조, 높은 감도
**단점**: 히스테리시스(hysteresis), 온도 의존성, 반복 사용 시 드리프트
...
**장점**: 높은 감도, 낮은 전력 소비, 근접 감지 가능
**단점**: 전자기 간섭(EMI)에 취약, 배선 복잡도
...
> **핵심 논문**: Bhirangi, R., Hellebrekers, T., Majidi, C., & Gupta, A. (2021). "ReSkin: Versatile, Replaceable, Lasting Tactile Skins." *arXiv preprint*.
> 자기 탄성체 기반의 저비용($6/개), 교체 가능한 촉각 피부. 산업 환경에서의 센서 내구성 문제에 대한 실용적 해답을 제시했습니다.

OSMO 글로브 [2025]는 12개의 3축 자기 센서를 사용하여 법선력과 전단력을 동시에 측정하며, MuMetal 차폐로 외부 자기장 간섭을 억제합니다 (→ Chapter 6.3 참조).
...
![Figure 2.1: 5가지 촉각 센서 변환 원리의 비교 — 압저항식, 정전용량식, 광학식, 자기식, 압전식.](../../assets/figures/ch02/fig_2_1_transduction_principles_technical.png)

### 변환 방식 비교

| 특성 | 압저항식 | 정전용량식 | 광학/비전 기반 | 자기식 | 압전식 |
|------|---------|----------|-------------|--------|--------|
| **공간 해상도** | 중간 | 중간 | 매우 높음 | 낮음-중간 | 낮음 |
| **힘 범위** | 넓음 | 넓음 | 중간 | 중간 | 넓음 (동적) |
| **다축 감지** | 어려움 | 가능 | 우수 | 우수 | 어려움 |
| **내구성** | 보통 | 보통 | 낮음 (젤 마모) | 높음 | 높음 |
| **비용** | 매우 낮음 | 낮음 | 중간 | 낮음 | 중간 |
| **크기** | 소형 | 소형 | 대형 (카메라) | 소형 | 소형 |
| **대표 센서** | STAG | — | GelSight, DIGIT | ReSkin, OSMO | — |
...
![Figure 2.4: 다축 촉각 센싱 — 법선력과 전단력의 역할 비교.](../../assets/figures/ch02/fig_2_4_multiaxis_force_technical.png)
...
- **0.1mm 해상도**: 미세 특징 감지
- **100% 다중 물체 파지 성공률**: 촉각 피드백의 직접적 효과
- **센서 배치 최적화**: 접촉 확률이 높은 영역에 센서 집중

![Figure 2.5: F-TAC Hand의 센서 배치 — 17개 촉각 센서의 분포와 커버리지. Source: F-TAC Hand (Nature Machine Intelligence, 2025).](../../assets/figures/ch02/fig_2_5_ftac_hand_technical.png)
