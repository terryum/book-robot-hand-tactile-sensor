...
sources:
  ...
  - "논문 요약 포스트: terry.artlab.ai (DexUMI, ExoStart, DEXOP, OSMO)"
...
인간의 시연 데이터(Chapter 6)를 로봇 정책으로 변환하려면, 인간과 로봇 사이의 **교차 체현 격차(cross-embodiment gap)**를 극복해야 합니다. 인간 손의 27 DoF와 로봇 핸드의 7-22 DoF는 근본적으로 다른 운동학적 구조이며, 시각적 외형과 촉각 특성도 상이합니다. 이 챕터에서는 운동학적, 시각적, 촉각적 세 차원의 격차와 각각의 해결 접근을 다룹니다.

> **이 챕터를 읽고 나면...**
> - 교차 체현 격차의 세 차원(운동학적, 시각적, 촉각적)을 구분할 수 있습니다.
> - AnyTeleop, ImMimic, DexH2R의 운동학적 리타게팅을 비교할 수 있습니다.
> - UniTacHand와 OSMO의 촉각 격차 해소 접근을 이해합니다.
...
![Figure 10.3: 시각적 격차 해소 — DexUMI와 RoboPaint.](../../assets/figures/ch10/fig_10_3_visual_gap_technical.png)
...
Zhang et al. [2025]:
- **MANO UV 맵**: 인간 손 표면을 2D UV 공간으로 전개
...
![Figure 10.6: 촉각 교차 체현 전이의 미해결 과제.](../../assets/figures/ch10/fig_10_6_future_challenges_technical.png)

---

## 요약 및 전망

Embodiment Retargeting은 운동학적(AnyTeleop, ImMimic), 시각적(DexUMI, RoboPaint), 촉각적(UniTacHand, OSMO), 기계적(DEXOP) 네 차원에서 진행되고 있습니다. 그러나 촉각 도메인의 교차 체현 전이는 여전히 1편의 논문(UniTacHand)만이 체계적으로 다루고 있으며, 이는 이 분야의 가장 큰 열린 문제입니다.
...
4. Xu, M., Zhang, H., Hou, Y., Xu, Z., Fan, L., Veloso, M., & Song, S. (2025). DexUMI: Using human hand as the universal manipulation interface for dexterous manipulation. *arXiv preprint*. arXiv:2505.21864.

5. Various. (2026). RoboPaint: From human demonstration to any robot and any view. *arXiv preprint*.

6. Zhang, C., Xue, Z., Yin, S., Zhao, B., et al. (2025). UniTacHand: Unified spatio-tactile representation for human to robotic hand skill transfer. *arXiv preprint*. arXiv:2512.21233.
...
9. Dan, P., et al. (2025). X-Sim: Cross-embodiment learning via real-to-sim-to-real. *arXiv preprint*.

10. Si, Z., Qian, K., Sontakke, N., et al. (2025). ExoStart: Efficient learning for dexterous manipulation with sensorized exoskeleton demonstrations. *arXiv preprint*. arXiv:2506.11775.
