...
1. Qin, Y., et al. (2023). AnyTeleop: A general vision-based dexterous robot teleoperation system. *RSS 2023*. [scholar](https://scholar.google.com/scholar?q=AnyTeleop%3A+A+general+vision-based+dexterous+robot+teleoperation+system)

2. Liu, Y., et al. (2025). ImMimic: Cross-domain imitation from human videos via mapping and interpolation. *arXiv preprint*. [scholar](https://scholar.google.com/scholar?q=ImMimic%3A+Cross-domain+imitation+from+human+videos+via+mapping+and+interpolation)

3. Li, Y., et al. (2024). DexH2R: Task-oriented dexterous manipulation from human to robots. *arXiv preprint*. arXiv:2411.04428. [scholar](https://scholar.google.com/scholar?q=DexH2R%3A+Task-oriented+dexterous+manipulation+from+human+to+robots)

4. Xu, M., Zhang, H., Hou, Y., Xu, Z., Fan, L., Veloso, M., & Song, S. (2025). DexUMI: Using human hand as the universal manipulation interface for dexterous manipulation. *arXiv preprint*. arXiv:2505.21864. [#8](https://terry.artlab.ai/ko/posts/2505-dexumi) [scholar](https://scholar.google.com/scholar?q=DexUMI%3A+Using+human+hand+as+the+universal+manipulation+interface+for+dexterous+manipulation)

5. Various. (2026). RoboPaint: From human demonstration to any robot and any view. *arXiv preprint*. [#15](https://terry.artlab.ai/ko/posts/2602-robopaint) [scholar](https://scholar.google.com/scholar?q=RoboPaint%3A+From+human+demonstration+to+any+robot+and+any+view)

6. Zhang, C., Xue, Z., Yin, S., Zhao, B., et al. (2025). UniTacHand: Unified spatio-tactile representation for human to robotic hand skill transfer. *arXiv preprint*. arXiv:2512.21233. [#16](https://terry.artlab.ai/ko/posts/2512-unitachand) [scholar](https://scholar.google.com/scholar?q=UniTacHand%3A+Unified+spatio-tactile+representation+for+human+to+robotic+hand+skill+transfer)

7. Yin, J., Qi, H., Wi, Y., Kundu, S., Lambeta, M., Yang, W., Wang, C., Wu, T., Malik, J., & Hellebrekers, T. (2025). OSMO: Open-source tactile glove for human-to-robot skill transfer. *arXiv preprint*. arXiv:2512.08920. [#18](https://terry.artlab.ai/ko/posts/2512-osmo-tactile-glove) [scholar](https://scholar.google.com/scholar?q=OSMO%3A+Open-source+tactile+glove+for+human-to-robot+skill+transfer)
...
9. Dan, P., et al. (2025). X-Sim: Cross-embodiment learning via real-to-sim-to-real. *CoRL 2025 (Oral)*. [scholar](https://scholar.google.com/scholar?q=X-Sim%3A+Cross-embodiment+learning+via+real-to-sim-to-real)

10. Si, Z., Qian, K., Sontakke, N., et al. (2025). ExoStart: Efficient learning for dexterous manipulation with sensorized exoskeleton demonstrations. *arXiv preprint*. arXiv:2506.11775. [#9](https://terry.artlab.ai/ko/posts/2506-exostart) [scholar](https://scholar.google.com/scholar?q=ExoStart%3A+Efficient+learning+for+dexterous+manipulation+with+sensorized+exoskeleton+demonstrations)

11. Shaw, K., Bahl, S., & Pathak, D. (2024). Learning dexterity from human hand motion in internet videos. *arXiv preprint*. arXiv:2212.04498. [scholar](https://scholar.google.com/scholar?q=Learning+dexterity+from+human+hand+motion+in+internet+videos)

12. Romero, J., Tzionas, D., & Black, M. J. (2017). Embodied hands (MANO). *SIGGRAPH Asia 2017*. [#17](https://terry.artlab.ai/ko/posts/2201-mano-hand-model) [scholar](https://scholar.google.com/scholar?q=Embodied+hands+%28MANO%29)

13. Various. (2025). Human2Sim2Robot: Learning from human video via sim-to-real transfer. *arXiv preprint*. [scholar](https://scholar.google.com/scholar?q=Human2Sim2Robot%3A+Learning+from+human+video+via+sim-to-real+transfer)

14. Various. (2025). AnyTouch: Unified static-dynamic tactile representation. *arXiv:2502.12191*. [scholar](https://scholar.google.com/scholar?q=AnyTouch%3A+Unified+static-dynamic+tactile+representation)

15. Various. (2025). Sensor-invariant tactile representation. *OpenReview*. [scholar](https://scholar.google.com/scholar?q=Sensor-invariant+tactile+representation)

16. Lv, Y., et al. (2025). ManipTrans: Efficient bimanual dexterous manipulation retargeting. *CVPR 2025*. [scholar](https://scholar.google.com/scholar?q=ManipTrans%3A+Efficient+bimanual+dexterous+manipulation+retargeting)

17. Park, J., et al. (2025). Joint motion manifold for human-to-robot hand retargeting. *arXiv preprint, Jan 2025*. [scholar](https://scholar.google.com/scholar?q=Joint+motion+manifold+for+human-to-robot+hand+retargeting)

18. Chen, B., et al. (2024). Mirage: Cross-embodiment zero-shot transfer via cross-painting. *RSS 2024*. [scholar](https://scholar.google.com/scholar?q=Mirage%3A+Cross-embodiment+zero-shot+transfer+via+cross-painting)

19. Various. (2025). H2R: Human-to-robot video augmentation for policy pretraining. *arXiv preprint*. [scholar](https://scholar.google.com/scholar?q=H2R%3A+Human-to-robot+video+augmentation+for+policy+pretraining)

20. Various. (2025). Masquerade: Human video to robot visual transformation. *arXiv preprint*. [scholar](https://scholar.google.com/scholar?q=Masquerade%3A+Human+video+to+robot+visual+transformation)

21. Kareer, S., et al. (2024). EgoMimic: Scaling imitation learning via egocentric video. *arXiv preprint*. [scholar](https://scholar.google.com/scholar?q=EgoMimic%3A+Scaling+imitation+learning+via+egocentric+video)

22. NVIDIA. (2026). EgoScale: Scaling robot policy learning with 20K hours of human egocentric data. *arXiv preprint, Feb 2026*. [scholar](https://scholar.google.com/scholar?q=EgoScale%3A+Scaling+robot+policy+learning+with+20K+hours+of+human+egocentric+data)

23. Various. (2026). AoE: Augmentation of experience via human ego demonstrations. *arXiv preprint, Feb 2026*. [scholar](https://scholar.google.com/scholar?q=AoE%3A+Augmentation+of+experience+via+human+ego+demonstrations)

24. Physical Intelligence. (2025). pi0 human-to-robot transfer: Co-finetuning for cross-embodiment generalization. *Technical Report, Dec 2025*. [#2](https://terry.artlab.ai/ko/posts/2410-pi0-vla-flow-model) [scholar](https://scholar.google.com/scholar?q=pi0+human-to-robot+transfer%3A+Co-finetuning+for+cross-embodiment+generalization)

25. Various. (2025). EgoZero: Zero robot data policy learning from smart glasses. *arXiv preprint*. [scholar](https://scholar.google.com/scholar?q=EgoZero%3A+Zero+robot+data+policy+learning+from+smart+glasses)

26. Various. (2025). VidBot: Internet video to 3D affordance for zero-shot robot control. *CVPR 2025*. [scholar](https://scholar.google.com/scholar?q=VidBot%3A+Internet+video+to+3D+affordance+for+zero-shot+robot+control)

27. Various. (2025). Human2Bot: Task similarity reward from human video for zero-shot robot control. *Autonomous Robots, 2025*. [scholar](https://scholar.google.com/scholar?q=Human2Bot%3A+Task+similarity+reward+from+human+video+for+zero-shot+robot+control)
