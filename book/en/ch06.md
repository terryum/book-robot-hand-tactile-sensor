...
6. Xu, M., Zhang, H., Hou, Y., Xu, Z., Fan, L., Veloso, M., & Song, S. (2025). DexUMI: Using human hand as the universal manipulation interface for dexterous manipulation. *arXiv preprint*. [#8](https://terry.artlab.ai/en/posts/2505-dexumi) [scholar](https://scholar.google.com/scholar?q=DexUMI%3A+Using+human+hand+as+the+universal+manipulation+interface+for+dexterous+manipulation)

7. Si, Z., et al. (2025). ExoStart: From 10 exoskeleton demos to dexterous robot manipulation. [#9](https://terry.artlab.ai/en/posts/2506-exostart) [scholar](https://scholar.google.com/scholar?q=ExoStart%3A+From+10+exoskeleton+demos+to+dexterous+robot+manipulation)

8. Fang, H.-S., Romero, B., Xie, Y., et al. (2025). DEXOP: A device for robotic transfer of dexterous human manipulation. *arXiv preprint*. arXiv:2509.04441. [#10](https://terry.artlab.ai/en/posts/2509-dexop) [scholar](https://scholar.google.com/scholar?q=DEXOP%3A+A+device+for+robotic+transfer+of+dexterous+human+manipulation)
...
14. Liu, Y., et al. (2025). ImMimic: Large-scale human trajectory + few-shot teleoperation interpolation. [scholar](https://scholar.google.com/scholar?q=ImMimic%3A+Large-scale+human+trajectory+++few-shot+teleoperation+interpolation)

15. Li, Y., et al. (2024). DexH2R: Task-oriented dexterous manipulation from human to robots. *arXiv preprint*. [scholar](https://scholar.google.com/scholar?q=DexH2R%3A+Task-oriented+dexterous+manipulation+from+human+to+robots)

16. Various. (2025). DOGlove: Low-cost open-source haptic feedback glove. [scholar](https://scholar.google.com/scholar?q=DOGlove%3A+Low-cost+open-source+haptic+feedback+glove)

17. Various. (2026). Feel Robot Feels: Tactile feedback array glove. [scholar](https://scholar.google.com/scholar?q=Feel+Robot+Feels%3A+Tactile+feedback+array+glove)
...
27. NuExo. (2025). NuExo: A 5.2 kg active upper-limb exoskeleton for dexterous teleoperation with 100% ROM. *ICRA 2025*. [scholar](https://scholar.google.com/scholar?q=NuExo%3A+A+5.2+kg+active+upper-limb+exoskeleton+for+dexterous+teleoperation+with+100%25+ROM)
