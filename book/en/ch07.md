...
1. Chi, C., Feng, S., Du, Y., Xu, Z., Cousineau, E., Burchfiel, B., & Song, S. (2023). Diffusion Policy: Visuomotor policy learning via action diffusion. *RSS 2023 / IJRR 2024*. arXiv:2303.04137. [scholar](https://scholar.google.com/scholar?q=Diffusion+Policy%3A+Visuomotor+policy+learning+via+action+diffusion)

2. Zhao, T. Z., Kumar, V., Levine, S., & Finn, C. (2023). Learning fine-grained bimanual manipulation with low-cost hardware (ACT/ALOHA). *RSS 2023*. arXiv:2304.13705. [scholar](https://scholar.google.com/scholar?q=Learning+fine-grained+bimanual+manipulation+with+low-cost+hardware+%28ACT%2FALOHA%29)

3. Various. (2020). OpenAI Dactyl: Solving Rubik's Cube with a robot hand. *IJRR*. [scholar](https://scholar.google.com/scholar?q=OpenAI+Dactyl%3A+Solving+Rubik%27s+Cube+with+a+robot+hand)

4. Handa, A., et al. (2023). DeXtreme: Transfer of agile in-hand manipulation from simulation to reality. *ICRA 2023*. arXiv:2210.13702. [scholar](https://scholar.google.com/scholar?q=DeXtreme%3A+Transfer+of+agile+in-hand+manipulation+from+simulation+to+reality)

5. Yin, Z.-H., et al. (2023). Rotating without seeing: Towards in-hand dexterity through touch. *RSS 2023*. [scholar](https://scholar.google.com/scholar?q=Rotating+without+seeing%3A+Towards+in-hand+dexterity+through+touch)

6. Yin, Z.-H., et al. (2024). Learning in-hand translation using a binary 3-axis tactile skin. *arXiv preprint*. [#13](https://terry.artlab.ai/en/posts/2407-tactile-skin-inhand-translation) [scholar](https://scholar.google.com/scholar?q=Learning+in-hand+translation+using+a+binary+3-axis+tactile+skin)

7. Pitz, J., et al. (2024). Dextrous tactile in-hand manipulation using modular RL. *Humanoid Robots*. [scholar](https://scholar.google.com/scholar?q=Dextrous+tactile+in-hand+manipulation+using+modular+RL)

8. Wu, C., et al. (2025). Canonical 3D tactile for visuo-tactile imitation learning. *ICRA 2025*. [#14](https://terry.artlab.ai/en/posts/2409-3dtactile-dex) [scholar](https://scholar.google.com/scholar?q=Canonical+3D+tactile+for+visuo-tactile+imitation+learning)

9. Yuan, Y., et al. (2024). Robot Synesthesia: In-hand manipulation with visuotactile sensing. *ICRA 2024*. [scholar](https://scholar.google.com/scholar?q=Robot+Synesthesia%3A+In-hand+manipulation+with+visuotactile+sensing)

10. Lin, P., Huang, Y., Li, W., Ma, J., Xiao, C., & Jiao, Z. (2025). PP-Tac: Paper picking using omnidirectional tactile feedback in dexterous robotic hands. *RSS 2025*. [#12](https://terry.artlab.ai/en/posts/2504-pp-tac) [scholar](https://scholar.google.com/scholar?q=PP-Tac%3A+Paper+picking+using+omnidirectional+tactile+feedback+in+dexterous+robotic+hands)

11. Chen, C., Yu, Z., Choi, H., Cutkosky, M., & Bohg, J. (2025). DexForce: Extracting force-informed actions from kinesthetic demonstrations for dexterous manipulation. *IEEE Robotics and Automation Letters*. [#3](https://terry.artlab.ai/en/posts/2501-dexforce-force-informed-actions) [scholar](https://scholar.google.com/scholar?q=DexForce%3A+Extracting+force-informed+actions+from+kinesthetic+demonstrations+for+dexterous+manipulation)

12. Yu, J., Liu, H., Yu, Q., et al. (2025). ForceVLA: Enhancing VLA models with a force-aware MoE for contact-rich manipulation. *NeurIPS 2025*. [#1](https://terry.artlab.ai/en/posts/2505-forcevla-force-aware-moe) [scholar](https://scholar.google.com/scholar?q=ForceVLA%3A+Enhancing+VLA+models+with+a+force-aware+MoE+for+contact-rich+manipulation)

13. Yu, M., et al. (2025). RGMC Champion: Kinematic trajectory optimization. *IEEE RA-L*. [scholar](https://scholar.google.com/scholar?q=RGMC+Champion%3A+Kinematic+trajectory+optimization)

14. Helmut, E., Funk, N., Schneider, T., de Farias, C., & Peters, J. (2025). Tactile-conditioned diffusion policy for force-aware robotic manipulation. *ICRA 2026*. arXiv:2510.13324. [scholar](https://scholar.google.com/scholar?q=Tactile-conditioned+diffusion+policy+for+force-aware+robotic+manipulation)

15. Hao, P., Zhang, C., Li, D., Cao, X., Hao, X., Cui, S., & Wang, S. (2025). TLA: Tactile-language-action model for contact-rich manipulation. *arXiv preprint*. arXiv:2503.08548. [scholar](https://scholar.google.com/scholar?q=TLA%3A+Tactile-language-action+model+for+contact-rich+manipulation)

16. Oller, M., Berenson, D., & Fazeli, N. (2024). Tactile-driven non-prehensile object manipulation via extrinsic contact mode control. *RSS 2024*. [scholar](https://scholar.google.com/scholar?q=Tactile-driven+non-prehensile+object+manipulation+via+extrinsic+contact+mode+control)

17. Various. (2025). Robust in-hand manipulation with motion-contact planning. *arXiv:2505.04978*. [scholar](https://scholar.google.com/scholar?q=Robust+in-hand+manipulation+with+motion-contact+planning)

18. Huang, J., Wang, S., Lin, F., Hu, Y., Wen, C., & Gao, Y. (2025). Tactile-VLA: Unlocking vision-language-action model's physical knowledge for tactile generalization. *OpenReview*. [scholar](https://scholar.google.com/scholar?q=Tactile-VLA%3A+Unlocking+vision-language-action+model%27s+physical+knowledge+for+tactile+generalization)

19. Various. (2024). Survey of learning-based in-hand manipulation. *Frontiers in Robotics and AI*. [scholar](https://scholar.google.com/scholar?q=Survey+of+learning-based+in-hand+manipulation)

20. Various. (2024). Robot intelligent grasping based on tactile perception. *Elsevier*. [scholar](https://scholar.google.com/scholar?q=Robot+intelligent+grasping+based+on+tactile+perception)

21. Zhao, C., Yu, Y., Ye, Z., Tian, Z., Zhang, Y., & Zeng, L.-L. (2025). Universal slip detection of robotic hand with tactile sensing. *Frontiers in Neurorobotics*, 19. https://doi.org/10.3389/fnbot.2025.1478758 [scholar](https://scholar.google.com/scholar?q=Universal+slip+detection+of+robotic+hand+with+tactile+sensing)

22. Li, Y., et al. (2025). Dexterous manipulation through imitation learning: A survey. *arXiv preprint*. arXiv:2504.03515. [scholar](https://scholar.google.com/scholar?q=Dexterous+manipulation+through+imitation+learning%3A+A+survey)

23. Hogan, N. (1985). Impedance control: An approach to manipulation. *JDSMC*, 107(1), 1-24. [scholar](https://scholar.google.com/scholar?q=Impedance+control%3A+An+approach+to+manipulation)

24. Various. (2025). LAPA: Latent action pretraining from human videos. *ICLR 2025*. [scholar](https://scholar.google.com/scholar?q=LAPA%3A+Latent+action+pretraining+from+human+videos)

25. Ye, L., et al. (2025). Visual-tactile self-supervised pretraining for robotic manipulation. *Science Robotics*. [scholar](https://scholar.google.com/scholar?q=Visual-tactile+self-supervised+pretraining+for+robotic+manipulation)

26. Choi, H., Kim, A., & Cutkosky, M. R. (2024). CoinFT: A compact and affordable capacitive six-axis force/torque sensor. *IEEE Sensors Journal*. [scholar](https://scholar.google.com/scholar?q=CoinFT%3A+A+compact+and+affordable+capacitive+six-axis+force%2Ftorque+sensor)

27. Choi, H., Hou, Y., Song, S., & Cutkosky, M. R. (2025). UMI-FT: Learning compliant manipulation at scale with force/torque sensing. *arXiv preprint*. [scholar](https://scholar.google.com/scholar?q=UMI-FT%3A+Learning+compliant+manipulation+at+scale+with+force%2Ftorque+sensing)

28. Choi, H. (2026). Multimodal Data for Robot Manipulation. *SNU Data Science Seminar*. [scholar](https://scholar.google.com/scholar?q=Multimodal+Data+for+Robot+Manipulation)

29. Zhao, T. Z., et al. (2024). ALOHA Unleashed: A simple recipe for robot dexterity. *CoRL 2024*. [scholar](https://scholar.google.com/scholar?q=ALOHA+Unleashed%3A+A+simple+recipe+for+robot+dexterity)

30. Adeniji, A., et al. (2025). Feel the Force: Contact-driven learning from humans. *arXiv:2506.01944*. [scholar](https://scholar.google.com/scholar?q=Feel+the+Force%3A+Contact-driven+learning+from+humans)
