...
![UMI-FT system overview — handheld gripper with CoinFT sensors enabling multimodal demonstration collection. Source: Choi et al. (2025), Fig. 1.](../../assets/figures/ch03/fig_umift_overview.png)

![UMI-FT learning pipeline — multimodal Diffusion Policy with low-level compliance controllers. Source: Choi et al. (2025), Fig. 2.](../../assets/figures/ch03/fig_umift_pipeline.png)
...
1. Albini, A., Kaboli, M., Cannata, G., & Maiolino, P. (2025). Representing data in robotic tactile perception — A review. *arXiv preprint* (submitted to IEEE T-RO). arXiv:2510.10804. [scholar](https://scholar.google.com/scholar?q=Representing+data+in+robotic+tactile+perception+%E2%80%94+A+review)

2. Yuan, Y., Che, H., Qin, Y., Huang, B., Yin, Z.-H., Lee, K.-W., Wu, Y., Lim, S.-C., & Wang, X. (2024). Robot Synesthesia: In-hand manipulation with visuotactile sensing. *ICRA 2024*. arXiv:2312.01853. [scholar](https://scholar.google.com/scholar?q=Robot+Synesthesia%3A+In-hand+manipulation+with+visuotactile+sensing)

3. Yang, F., Feng, C., Chen, Z., Park, H., Wang, D., Dou, Y., ... & Wong, A. (2024). Binding touch to everything: Learning unified multimodal tactile representations. *CVPR 2024*. [scholar](https://scholar.google.com/scholar?q=Binding+touch+to+everything%3A+Learning+unified+multimodal+tactile+representations)

4. Higuera, C., Sharma, A., Bodduluri, C. K., Fan, T., Lancaster, P., Malik, J., Pathak, D., Lambeta, M., & Calandra, R. (2024). Sparsh: Self-supervised touch representations for vision-based tactile sensing. *CoRL 2024*. [scholar](https://scholar.google.com/scholar?q=Sparsh%3A+Self-supervised+touch+representations+for+vision-based+tactile+sensing)

5. Liu, Q., Cui, Y., Sun, Z., Li, G., Chen, J., & Ye, Q. (2025). VTDexManip: A dataset and benchmark for visual-tactile pretraining and dexterous manipulation with reinforcement learning. *ICLR 2025*. [scholar](https://scholar.google.com/scholar?q=VTDexManip%3A+A+dataset+and+benchmark+for+visual-tactile+pretraining+and+dexterous+manipulation+with+reinforcement+learning)

6. Feng, R., Hu, J., Xia, W., Gao, T., Shen, A., Sun, Y., Fang, B., & Hu, D. (2025). AnyTouch: Learning unified static-dynamic representation across multiple visuo-tactile sensors. *ICLR 2025*. arXiv:2502.12191. [scholar](https://scholar.google.com/scholar?q=AnyTouch%3A+Learning+unified+static-dynamic+representation+across+multiple+visuo-tactile+sensors)

7. Various. (2025). AnyTouch 2: General optical tactile representation learning for dynamic tactile perception. *OpenReview*. [scholar](https://scholar.google.com/scholar?q=AnyTouch+2%3A+General+optical+tactile+representation+learning+for+dynamic+tactile+perception)

8. Various. (2025). Sensor-invariant tactile representation. *OpenReview*. [scholar](https://scholar.google.com/scholar?q=Sensor-invariant+tactile+representation)

9. Wu, C., et al. (2025). Canonical 3D tactile representation for visuo-tactile imitation learning. *ICRA 2025*. [#14](https://terry.artlab.ai/en/posts/2409-3dtactile-dex) [scholar](https://scholar.google.com/scholar?q=Canonical+3D+tactile+representation+for+visuo-tactile+imitation+learning)

10. Wang, S., Lambeta, M., et al. (2022). Tacto: A fast, flexible, and open-source simulator for vision-based tactile sensors. *IEEE Robotics and Automation Letters*. [scholar](https://scholar.google.com/scholar?q=Tacto%3A+A+fast%2C+flexible%2C+and+open-source+simulator+for+vision-based+tactile+sensors)

11. Si, Z., Zhang, G., Ben, Q., Romero, B., Xian, Z., Liu, C., & Gan, C. (2024). DiffTactile: A physics-based differentiable tactile simulator for contact-rich robotic manipulation. *ICLR 2024*. [scholar](https://scholar.google.com/scholar?q=DiffTactile%3A+A+physics-based+differentiable+tactile+simulator+for+contact-rich+robotic+manipulation)

12. Sundaram, S., Kellnhofer, P., Li, Y., Zhu, J.-Y., Torralba, A., & Matusik, W. (2019). Learning the signatures of the human grasp using a scalable tactile glove. *Nature*, 569, 698-702. [scholar](https://scholar.google.com/scholar?q=Learning+the+signatures+of+the+human+grasp+using+a+scalable+tactile+glove)

13. Zhang, C., Xue, Z., Yin, S., Zhao, B., et al. (2025). UniTacHand: Unified spatio-tactile representation for human to robotic hand skill transfer. *arXiv preprint*. arXiv:2512.21233. [#16](https://terry.artlab.ai/en/posts/2512-unitachand) [scholar](https://scholar.google.com/scholar?q=UniTacHand%3A+Unified+spatio-tactile+representation+for+human+to+robotic+hand+skill+transfer)

14. Chen, C., Yu, Z., Choi, H., Cutkosky, M., & Bohg, J. (2025). DexForce: Extracting force-informed actions from kinesthetic demonstrations for dexterous manipulation. *IEEE Robotics and Automation Letters*. arXiv:2501.10356. [#3](https://terry.artlab.ai/en/posts/2501-dexforce-force-informed-actions) [scholar](https://scholar.google.com/scholar?q=DexForce%3A+Extracting+force-informed+actions+from+kinesthetic+demonstrations+for+dexterous+manipulation)

15. Lin, P., Huang, Y., Li, W., Ma, J., Xiao, C., & Jiao, Z. (2025). PP-Tac: Paper picking using omnidirectional tactile feedback in dexterous robotic hands. *RSS 2025*. [#12](https://terry.artlab.ai/en/posts/2504-pp-tac) [scholar](https://scholar.google.com/scholar?q=PP-Tac%3A+Paper+picking+using+omnidirectional+tactile+feedback+in+dexterous+robotic+hands)

16. Open X-Embodiment Collaboration. (2024). Open X-Embodiment: Robotic learning datasets and RT-X models. *ICRA 2024*. arXiv:2310.08864. [scholar](https://scholar.google.com/scholar?q=Open+X-Embodiment%3A+Robotic+learning+datasets+and+RT-X+models)

17. Various. (2024). Tactile sensing for dexterous manipulation: Taxonomies, datasets, and sim-to-real transfer. *Journal of Multidisciplinary Engineering Science*. [scholar](https://scholar.google.com/scholar?q=Tactile+sensing+for+dexterous+manipulation%3A+Taxonomies%2C+datasets%2C+and+sim-to-real+transfer)

18. Yang, F., et al. (2023). Touch and Go: Learning from human-collected vision and touch. *ICCV 2023*. [scholar](https://scholar.google.com/scholar?q=Touch+and+Go%3A+Learning+from+human-collected+vision+and+touch)

19. Yang, F., et al. (2024). Touch100k: A large-scale touch-language-vision dataset. *arXiv preprint*. arXiv:2406.03813. [scholar](https://scholar.google.com/scholar?q=Touch100k%3A+A+large-scale+touch-language-vision+dataset)

20. Gao, R., et al. (2022). ObjectFolder 2.0: A multisensory object dataset for sim2real transfer. *ICML 2022*. [scholar](https://scholar.google.com/scholar?q=ObjectFolder+2.0%3A+A+multisensory+object+dataset+for+sim2real+transfer)

21. Yin, J., Qi, H., Wi, Y., Kundu, S., Lambeta, M., Yang, W., Wang, C., Wu, T., Malik, J., & Hellebrekers, T. (2025). OSMO: Open-source tactile glove for human-to-robot skill transfer. *arXiv preprint*. arXiv:2512.08920. [#18](https://terry.artlab.ai/en/posts/2512-osmo-tactile-glove) [scholar](https://scholar.google.com/scholar?q=OSMO%3A+Open-source+tactile+glove+for+human-to-robot+skill+transfer)

22. Various. (2025). EgoDex: Large-scale egocentric hand manipulation dataset via Apple Vision Pro. *arXiv preprint*. [scholar](https://scholar.google.com/scholar?q=EgoDex%3A+Large-scale+egocentric+hand+manipulation+dataset+via+Apple+Vision+Pro)

23. Choi, H., Kim, A., & Cutkosky, M. R. (2024). CoinFT: A compact and affordable capacitive six-axis force/torque sensor. *IEEE Sensors Journal*. https://coin-ft.github.io/ [scholar](https://scholar.google.com/scholar?q=CoinFT%3A+A+compact+and+affordable+capacitive+six-axis+force%2Ftorque+sensor)

24. Choi, H., Hou, Y., Song, S., & Cutkosky, M. R. (2025). UMI-FT: Learning compliant manipulation at scale with force/torque sensing. *arXiv preprint*. [scholar](https://scholar.google.com/scholar?q=UMI-FT%3A+Learning+compliant+manipulation+at+scale+with+force%2Ftorque+sensing)

25. Choi, H. (2026). Multimodal Data for Robot Manipulation. *SNU Data Science Seminar*. [scholar](https://scholar.google.com/scholar?q=Multimodal+Data+for+Robot+Manipulation)
