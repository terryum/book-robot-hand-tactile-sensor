...
sources:
  - "SNU Seminar: 260323_Seminar_Taejoon_DataGlove_Sensors"
...
**Strengths**: Low cost, simple construction, high sensitivity
**Limitations**: Hysteresis, temperature dependence, drift under repeated use
...
**Strengths**: High sensitivity, low power consumption, proximity sensing
**Limitations**: Susceptibility to electromagnetic interference (EMI), wiring complexity
...
![Figure 2.1: Comparison of five tactile sensor transduction principles — piezoresistive, capacitive, optical, magnetic, piezoelectric.](../../assets/figures/ch02/fig_2_1_transduction_principles_technical.png)

### Transduction Comparison

| Property | Piezoresistive | Capacitive | Optical/Vision | Magnetic | Piezoelectric |
|----------|---------------|------------|---------------|----------|--------------|
| **Spatial resolution** | Medium | Medium | Very high | Low-Medium | Low |
| **Force range** | Wide | Wide | Medium | Medium | Wide (dynamic) |
| **Multi-axis** | Difficult | Possible | Excellent | Excellent | Difficult |
| **Durability** | Moderate | Moderate | Low (gel wear) | High | High |
| **Cost** | Very low | Low | Medium | Low | Medium |
| **Size** | Compact | Compact | Bulky (camera) | Compact | Compact |
| **Representative** | STAG | — | GelSight, DIGIT | ReSkin, OSMO | — |
