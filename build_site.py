  ...
  <header class="site-header">
    ...
    <div class="header-right">
      <div class="lang-toggle">
        <a href="../ko/ch{ch_num:02d}.html" class="{'active' if lang_code == 'ko' else ''}">KO</a>
        <a href="../en/ch{ch_num:02d}.html" class="{'active' if lang_code == 'en' else ''}">EN</a>
      </div>
    </div>
  </header>
...
<body{' class="lang-en"' if lang_code == 'en' else ''}>
  ...
  <header class="site-header">
    ...
    <div class="header-right">
      <div class="lang-toggle">
        <a href="../ko/glossary.html" class="{'active' if lang_code == 'ko' else ''}">KO</a>
        <a href="../en/glossary.html" class="{'active' if lang_code == 'en' else ''}">EN</a>
      </div>
    </div>
  </header>
...
<body{' class="lang-en"' if lang_code == 'en' else ''}>
  ...
  <header class="site-header">
    ...
    <div class="header-right">
      <div class="lang-toggle">
        <a href="../ko/references.html" class="{'active' if lang_code == 'ko' else ''}">KO</a>
        <a href="../en/references.html" class="{'active' if lang_code == 'en' else ''}">EN</a>
      </div>
    </div>
  </header>
